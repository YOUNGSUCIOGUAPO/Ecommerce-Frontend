      ...
      <div className='overlay-content'>
        <div className='flex'>
          <div className='h-[4.5rem] w-[4.5rem] rounded-[50%] mr-[1.44rem] bg-white flex flex-col justify-center items-center'>
            <span className={`font-poppins text-[16px] font-semibold leading-none`}>{timeLeft.hours}</span>
            <span className={`font-poppins text-[12px]`}>Hours</span>
          </div>
          <div className='h-[4.5rem] w-[4.5rem] rounded-[50%] mr-[1.44rem] bg-white flex flex-col justify-center items-center'>
            <span className={`font-poppins text-[16px] font-semibold leading-none`}>{timeLeft.days}</span>
            <span className={`font-poppins text-[12px]`}>Days</span>
          </div>
          <div className='h-[4.5rem] w-[4.5rem] rounded-[50%] mr-[1.44rem] bg-white flex flex-col justify-center items-center'>
            <span className={`font-poppins text-[16px] font-semibold leading-none`}>{timeLeft.minutes}</span>
            <span className={`font-poppins text-[12px]`}>Minutes</span>
          </div>
          <div className='h-[4.5rem] w-[4.5rem] rounded-[50%] mr-[1.44rem] bg-white flex flex-col justify-center items-center'>
            <span className={`font-poppins text-[16px] font-semibold leading-none`}>{timeLeft.seconds}</span>
